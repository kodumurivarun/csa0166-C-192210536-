...
int main() {
    ...
    e4->showdata(); // This will not produce correct output after delete, as the object is deleted
    e5->showdata(); // This will not produce correct output after delete, as the object is deleted
